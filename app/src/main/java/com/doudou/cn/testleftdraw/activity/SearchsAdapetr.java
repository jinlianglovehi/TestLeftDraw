...
import com.doudou.cn.testleftdraw.utils.RecyclerViewAdapter;
import com.doudou.cn.testleftdraw.utils.SwipeItemLayout;
...
public class SearchsAdapetr extends RecyclerViewAdapter<SearchsAdapetr.SearchsViewHolder> {
     private static final String TAG = "SearchsAdapetr";
    ...
    public List<? extends View> creatMenuView() {
        ...
        menu1.setCompoundDrawables(mContext.getResources().getDrawable(R.mipmap.ic_camera_alt_white_24dp),null,null,null);
        menu1.setText("删除");
        menu1.setTextColor(Color.parseColor("#ffffff"));
        menu1.setTextSize(14);
        menu1.setPadding(10,0,10,0);
        menuViews.add(menu1);
        ...
        menu2.setCompoundDrawables(mContext.getResources().getDrawable(R.mipmap.ic_camera_alt_white_24dp),null,null,null);
        menu2.setText("取消");
            ...
            public void swipeMenuClickEvent(int position) {
                switch (position){
                    case 0:
                        ...
                        Log.i(TAG, "swipeMenuClickEvent: "+position);
                        mSearchVoList.remove(position);
